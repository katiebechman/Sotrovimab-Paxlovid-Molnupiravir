...
study = StudyDefinition(
  ...
  downs_syndrome_nhsd=patients.maximum_of("downs_syndrome_snomed","downs_syndrome_icd"),
  ...
  solid_organ_transplant_nhsd = patients.maximum_of("solid_organ_transplant_nhsd_snomed", "solid_organ_transplant_nhsd_snomed_new", 
  ...
  neurological_disease_nhsd = patients.maximum_of("multiple_sclerosis_nhsd_snomed", "multiple_sclerosis_nhsd_icd10", 
  ...
  eligible = patients.maximum_of("downs_syndrome_nhsd", 
